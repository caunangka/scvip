...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/YogzKYT/permission/main/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/YogzKYT/permission/main/ip | grep $MYIP | awk '{print $2}')
